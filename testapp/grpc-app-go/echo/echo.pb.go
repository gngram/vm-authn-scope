...
type EchoResponse struct {
	...
	PeerIdentity  string                 `protobuf:"bytes,3,opt,name=peer_identity,json=peerIdentity,proto3" json:"peer_identity,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *EchoResponse) GetPeerIdentity() string {
	if x != nil {
...
const file_echo_proto_rawDesc = "" +
	...
	"\rpeer_identity\x18\x03 \x01(\tR\fpeerIdentity2<\n" +
	"\vEchoService\x12-\n" +
	"\x04Echo\x12\x11.echo.EchoRequest\x1a\x12.echo.EchoResponseB\x12Z\x10grpc-app-go/echob\x06proto3"
